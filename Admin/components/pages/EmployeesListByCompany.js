...
export default function EmployeesListByCompany(props) {
    ...
    // NEEDS TO ADD EMPLOYER TO COMPANY
    const {
        data: employees,
        ...
        'getPlanCompanyId',
        () => EmployeeService.getEmployeesByCompanyId(props.companyFilter),
        {
            enabled: !!props.companyFilter,
            cacheTime: 0,
        }
    );
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 130,
            valueGetter: (params) => {
                return `${params.row?.employer?.firstName || ''} ${
